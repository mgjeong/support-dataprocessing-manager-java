...
public class JobControllerTest {
    ...
    public void createJobTest() throws Exception {
        ...
        when(jobManager.createGroupJob((JobGroupFormat) notNull())).thenReturn(mockResponse);
    ...
    public void updateJobsTest() throws Exception {
        ...
        when(jobManager.updateJob(anyString(), (JobGroupFormat) notNull())).thenReturn(mockResponse);

        String jsonUpdate = "{\"jobs\":[{\"input\":[{\"dataType\":\"ZMQ\",\"dataSource\":\"localhost:5555:topic\"}],"
