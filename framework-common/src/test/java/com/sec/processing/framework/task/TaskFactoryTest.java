...
public class TaskFactoryTest {
    ...
    public static List<Map<String, String>> makeMockPayload() {
        ...
        regression1.put(TaskTableManager.Entry.classname.name(), "com.sec.processing.framework.task.model.SVMModel");
        ...
        classification.put(TaskTableManager.Entry.classname.name(), "com.sec.processing.framework.task.model.Test");
