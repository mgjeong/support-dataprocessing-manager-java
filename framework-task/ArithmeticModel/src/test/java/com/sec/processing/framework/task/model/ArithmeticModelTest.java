...
public class ArithmeticModelTest {
    ...
    private static final String OPERATONS     = "operations";
    ...
    @Test
    public void testAddOperationOnSingle() {
        TaskModelParam op1 = new TaskModelParam();
        op1.put(OPERAND_LEFT, "/KEY_A");
        op1.put(OPERAND_RIGHT, "/KEY_B");
        op1.put(OPERATOR, OPERATOR_ADD);
        op1.put(TYPE, TYPE_SINGLE);
        op1.put(RESULT, "/"+OPERATOR_ADD);

        List<TaskModelParam> operations = new ArrayList<>();
        operations.add(op1);

        Number[] left  = {1, 123123, 2.2};
        Number[] right = {1, 321321, 3.3};

        TaskModelParam params = new TaskModelParam();
        params.put(OPERATONS, operations);

        ArithmeticModel model = new ArithmeticModel();
        model.setParam(params);
        System.out.println("====== ADDITION WITH ======== : "+params.toString());
        for (int i = 0; i < left.length; i++) {
            //for (int i = 0; i < 2; i++) {
            DataSet dataSet = DataSet.create();

            dataSet.put("KEY_A", left[i]);
            dataSet.put("KEY_B", right[i]);
    ...
    @Test
    public void testSubOperationOnSingle() {
        TaskModelParam op1 = new TaskModelParam();
        op1.put(OPERAND_LEFT, "/KEY_A");
        op1.put(OPERAND_RIGHT, "/KEY_B");
        op1.put(OPERATOR, OPERATOR_SUB);
        op1.put(TYPE, TYPE_SINGLE);
        op1.put(RESULT,  "/"+OPERATOR_SUB);
        ...
        ArithmeticModel model = new ArithmeticModel();
        model.setParam(params);
        System.out.println("====== SUBTRACTION WITH ======== : "+params.toString());
        for (int i = 0; i < left.length; i++) {
            //for (int i = 0; i < 2; i++) {
            DataSet dataSet = DataSet.create();
    ...
    @Test
    public void testMulOperationOnSingle() {
        TaskModelParam op1 = new TaskModelParam();
        op1.put(OPERAND_LEFT, "/KEY_A");
        op1.put(OPERAND_RIGHT, "/KEY_B");
        op1.put(OPERATOR, OPERATOR_MUL);
        op1.put(TYPE, TYPE_SINGLE);
        op1.put(RESULT,  "/"+OPERATOR_MUL);
        ...
        ArithmeticModel model = new ArithmeticModel();
        model.setParam(params);
        System.out.println("====== MULTIPLICATION WITH ======== : "+params.toString());
        for (int i = 0; i < left.length; i++) {
            //for (int i = 0; i < 2; i++) {
            DataSet dataSet = DataSet.create();
    ...
    @Test
    public void testDivOperationOnSingle() {
        TaskModelParam op1 = new TaskModelParam();
        op1.put(OPERAND_LEFT, "/KEY_A");
        op1.put(OPERAND_RIGHT, "/KEY_B");
        op1.put(OPERATOR, OPERATOR_DIV);
        op1.put(TYPE, TYPE_SINGLE);
        op1.put(RESULT,  "/"+OPERATOR_DIV);
        ...
        ArithmeticModel model = new ArithmeticModel();
        model.setParam(params);
        System.out.println("====== DIVISION WITH ======== : "+params.toString());
        for (int i = 0; i < left.length; i++) {
            //for (int i = 0; i < 2; i++) {
            DataSet dataSet = DataSet.create();
    ...
    @Test
    public void testModOperationOnSingle() {
        TaskModelParam op1 = new TaskModelParam();
        op1.put(OPERAND_LEFT, "/KEY_A");
        op1.put(OPERAND_RIGHT, "/KEY_B");
        op1.put(OPERATOR, OPERATOR_MOD);
        op1.put(TYPE, TYPE_SINGLE);
        op1.put(RESULT,  "/"+OPERATOR_MOD);
        ...
        ArithmeticModel model = new ArithmeticModel();
        model.setParam(params);
        System.out.println("====== MODULUS WITH ======== : "+params.toString());
        for (int i = 0; i < left.length; i++) {
            //for (int i = 0; i < 2; i++) {
            DataSet dataSet = DataSet.create();
    ...
    @Test
    public void testArithmeticOperationOnArray() {

        ArithmeticModel model = new ArithmeticModel();
        System.out.println(""+model.getDefaultParam().toString());
        model.setParam(model.getDefaultParam());
