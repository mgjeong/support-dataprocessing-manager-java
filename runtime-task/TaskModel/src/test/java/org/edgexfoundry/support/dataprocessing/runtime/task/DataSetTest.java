...
import org.edgexfoundry.support.dataprocessing.runtime.task.DataSet.Record;
...
public class DataSetTest {
  ...
  public void testSimpleStreamData() {
    ...
    Assert.assertEquals(sampleJson.get("height").getAsDouble(), record.get("height").getAsDouble(),
        0.005);
  ...
  public void testGetValue() {
    ...
    Record streamedRecord = dataSet.getStreamedRecord();
    Assert.assertNotNull(streamedRecord);
  }
  ...
  public void testSetValue() {
    ...
    System.out.println(dataSet.toString());
    Assert
        .assertEquals(dataSet.getRecords().get(dataSet.getRecords().size() - 1).get("last"), true);
  }
