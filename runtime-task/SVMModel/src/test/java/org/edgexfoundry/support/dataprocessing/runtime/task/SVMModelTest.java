...
public class SVMModelTest {
  ...
  public void testLinearPrediction() {
    ...
    double[][] trainedCoef = {
        {1.1037055147699631E-4, 1.1037055147699631E-4, -1.1037055147699631E-4,
    ...
    params.put("sVectors", sVectorList);
  ...
  public void testRadialPrediction() {
    ...
    params.put("kernelType", "radial");
    params.put("gamma", 0.25);
    params.put("coef0", 0.0);
