...
func getEvent() emf.Event {
	...
	var rName string = "params"
	reading1.Name = &rName
	var rValue string = "{\"input\":[{\"dataType\":\"EMF\",\"dataSource\":\"localhost:5563\",\"topics\":[\"a\",\"b\"]}],\"output\":[{\"dataType\":\"UDP\",\"dataSource\":\"localhost:1234\"},{\"dataType\":\"EMF\",\"dataSource\":\"localhost:1234\",\"topics\":[\"a\",\"b\"]}]}"
